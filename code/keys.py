...
default_alphabet = "arch brov char delta echo foxy goof hotel India julia kilo Lima Mike Novakeen oscar prime Quebec Romeo Sierra tango uniform victor whiskey xray yankee Zulu".split(
    " "
)
